...
namespace MichelinDevPetstoreLib\Utils;
...
use MichelinDevPetstoreLib\Http\HttpContext;
use MichelinDevPetstoreLib\Http\HttpRequest;
use MichelinDevPetstoreLib\Http\HttpResponse;
