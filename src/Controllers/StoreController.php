...
use MichelinDevPetstoreLib\Models\Order;
use MichelinDevPetstoreLib\Models\StatusEnum;
    ...
    public function placeOrder(
        ...
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/store/order')
            ->parameters(
                ...
                FormParam::init('status', $status)->serializeBy([StatusEnum::class, 'checkValue']),
