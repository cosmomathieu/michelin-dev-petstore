...
namespace MichelinDevPetstoreLib\Exceptions;
...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \MichelinDevPetstoreLib\Http\HttpRequest $request
     * @param \MichelinDevPetstoreLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \MichelinDevPetstoreLib\Http\HttpRequest $request,
        \MichelinDevPetstoreLib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \MichelinDevPetstoreLib\Models\OAuthProviderErrorEnum::checkValue
     */
