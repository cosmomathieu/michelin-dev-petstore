...
use MichelinDevPetstoreLib\Utils\DateTimeHelper;
use stdClass;
...
class Order implements \JsonSerializable
{
     ...
     *
     * @maps shipDate
     * @factory \MichelinDevPetstoreLib\Utils\DateTimeHelper::fromRfc3339DateTime
     */
     ...
     *
     * @maps status
     * @factory \MichelinDevPetstoreLib\Models\StatusEnum::checkValue
     */
    ...
    public function toXmlElement(XmlSerializer $serializer, \DOMElement $element): void
    {
        ...
        $serializer->addAsSubelement($element, 'status', StatusEnum::checkValue($this->status));
    ...
    public static function fromXmlElement(XmlDeserializer $serializer, \DOMElement $element)
    {
        ...
        $shipDate = \MichelinDevPetstoreLib\Utils\DateTimeHelper::fromRfc3339DateTime($shipDate);
        $instance->setShipDate($shipDate);

        $status = $serializer->fromElement($element, 'status', '?string');
        $status = \MichelinDevPetstoreLib\Models\StatusEnum::checkValue($status);
